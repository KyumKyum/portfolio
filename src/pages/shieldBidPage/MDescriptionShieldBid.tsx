...
function MDescriptionShieldBid() {
    return (
        <div className="flex flex-col h-full bg-white mx-4 py-10">
            <div className="flex flex-col h-full items-center p-10">
                <div className="flex flex-col w-full items-center mb-4">
                    ...
                    <span>
                    <ScramblingText
                            className="text-2xl font-GW text-[#353839]"
            ...
            <div className="flex flex-col w-full px-10 mb-8">
                ...
                <div className="flex flex-col justify-center flex-wrap">
                    ...
                    ShieldBid는 <span className="text-[#0E4A84]">한양대학교 IC-PBL 프로젝트</span>로서
                        ...
                        <br /><span className="italic">입찰가 비공개 경매
                        <br/>(Sealed-bid Auction) 플랫폼</span> 입니다.
                    </p>
                    <p className="font-Suit text-xs mb-6 text-center">
                    입찰가 비공개 경매는 입찰 금액이 비공개이며,
                        <br /><span className="italic">다른 입찰자의 금액을 알지 못하는 상태</span>에서
                        <br/>진행되는 거래 방식입니다.
                    </p>
                    <p className="font-Suit text-xs mb-6 text-center">
                    이에 ShieldBid는 <span className="text-[#3E3456]">블록체인</span>을 활용하여
                        <br/>데이터 무결성을 확보하고
                        <br /><span className="text-[#3832A8]">영지식 증명 기술</span>을 활용하여 
                        <br/>입찰가 검증 기능을 제공함으로서
                        <br />기존 경매 방식과는 차별화된
                        <br/>경매 서비스를 제공합니다.
                    </p>
                    <p className="font-Suit text-xs mb-6 text-center">
                        학부연구생 때 배웠던 <span className="text-violet-700">이더라움 블록체인</span>과 
                        <br/><span className="text-[#3832A8]">영지식 증명 기술</span>을 활용하여 서비스를 구현하였고,
                        <br/><span className="text-amber-600">Metamask</span>을 활용하여 성공적으로
                        <br/>서비스의 배포 Contract를 만들었습니다.
                        <br/>하지만 블록체인 배포 및 검증 작업은 
                        <br/>상당히 오랜 시간이 걸리기 때문에
                        <br/>정상적인 서비스를 위해서는
                        <br/>추가적인 조치가 필요한 상황이었습니다.
                    </p>

                    <p className="font-Suit text-xs text-center">
                    이로 인해 발생하는 문제는
                    <br/><span className="text-rose-800">MSA</span>구조로 백엔드를 설계하여
                        <br />블록체인 로직과 일반 서비스 로직의
                        <br/><span className="text-cyan-600">비동기 파이프라인</span>을 구축하는 것으로 해결했습니다.
                        <br />해당 구조로 인해 Shieldbid는
                        <br/>블록체인을 사용함에도 불구하고
                        <br />사용자에게 <span className="font-bold">빠르고 원활한 서비스를
                        <br/>제공</span>할 수 있습니다.
                    </p>
                </div>
            </div>
            <div className="flex flex-col w-full px-10 mb-8">
                <div className="flex flex-wrap flex-col justify-center items-center">
                    <p className="font-Suit text-cemter mb-8 text-center">
                        프로젝트 요약: <br/><span className="text-red-700">MSA 구조 설계 및 백엔드 개발</span>
                    </p>
...
export default MDescriptionShieldBid;
