...
function MSkills() {
    return (
        <div className="flex flex-col justify-center items-center bg-stone-800 py-10">
            <span className="w-full text-center text-3xl font-FS text-white my-10">Tech Stacks</span>
