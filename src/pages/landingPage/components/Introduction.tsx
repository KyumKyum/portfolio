...
function Introduction() {
    return (
        <div className="flex h-screen flex-col justify-center items-center bg-slate-200">
            <span className="text-4xl font-FS text-black my-10">
                "A Developer Who Loves Developing ;)"
            </span>
            ...
            <span className="font-Suit text-black text-center">
                <span>안녕하세요! </span>
                <GradientText className="font-bold" startColor="from-blue-400" middleColor="via-indigo-600" endColor="to-violet-900" text="개발이 좋아서 개발자가 된 " />
                <span>임규민 (Jay Lim)입니다.</span>
                <br />
                <GradientText className="font-bold" startColor="from-red-400" middleColor="via-orange-600" endColor="to-yellow-900" text="서비스의 구조를 설계하고 기능을 창조한다는 것" />
                <span>에 매력을 느끼고, </span>
                <GradientText className="font-bold" startColor="from-emerald-400" middleColor="via-teal-600" endColor="to-cyan-900" text="끝없는 배움의 길에 재미를 느끼며" />
                <span> 성장하고 있습니다.</span>
                <br />
                <span>현재 </span>
                <GradientText className="font-bold" startColor="from-cyan-400" middleColor="via-sky-600" endColor="to-blue-900" text="서버 구조와 MSA 설계" />
                <span>에 관심이 있으며,</span>
                <GradientText className="font-bold" startColor="from-fuchsia-400" middleColor="via-pink-600" endColor="to-rose-900" text="데브옵스와 클라우드 엔지니어링" />
            ...
            <div className="flex mt-12">
                ...
                <button
                    ...
                    onClick={() => {
                        window.open("https://www.instagram.com/kyumerican0/", "_blank");
                    }}
                >
                    <IG width={16} height={16} />
                    <span className="text-sm font-Suit text-black ml-2">@kyumerican0</span>
                </button>
            </div>
        </div>
    );
