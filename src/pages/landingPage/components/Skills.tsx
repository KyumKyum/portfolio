    ...
    return (
        <div className="flex h-screen flex-col justify-center items-center bg-stone-800">
            <span className="w-full text-center text-4xl font-FS text-white my-10">
                Introducing, My Tech Stacks!
            </span>
            <div className="flex flex-wrap justify-center gap-6 mb-10">
                <SkillCard title="Languages" description="제가 개발할 때 즐겨 사용하는 언어입니다." tags={[
                ...
                <SkillCard title="Frontend" description="프론트엔드 개발 시 사용하는 프레임워크입니다." tags={[
                ...
                <SkillCard title="Application" description="모바일/데스크톱 앱 개발 시 사용하는 프레임워크입니다." tags={[
                ...
                <SkillCard title="Backend" description="뱍앤드 개발 시 사용하는 프레임워크입니다." tags={[
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-10">
                <SkillCard title="ORM" description="사용하는 데이터베이스 ORM 툴입니다." tags={[
                    { name: "Prisma", bgColor: "bg-[#4081a9]", textColor: "text-white" },
                    { name: "TypeORM", bgColor: "bg-[#FFAB00]", textColor: "text-black" },
                ]} />
                <SkillCard title="DevOps / Monitoring" description="사용 가능한 데브옵스/모니터링 플랫폼과 툴입니다." tags={[
                ...
                <SkillCard title="MSA Architecture" description="MSA 구조를 설계할 때 사용하는 플랫폼과 툴입니다." tags={[
                ...
                <SkillCard title="Currently Studing" description="현재 공부하고 있는 언어와 기술들입니다." tags={[
