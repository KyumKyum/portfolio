...
import MCareerCard from "./MCareerCard";

function MCareers() {
    return (
        <div className="flex min-h-svh flex-col justify-center items-center bg-yellow-500 py-10">
            <span className="w-full text-center text-3xl font-FS text-black my-4">
                Careers
            </span>
            <div className="flex flex-wrap justify-center items-center w-full h-full gap-6 m-4">
                ...
                <MCareerCard cardImageUrl={SnP} title="SnP Lab" description="연구원 (보안), 2023.09 ~ 2024.02" details={[
                    {
                ...
                <MCareerCard cardImageUrl={Zkrypto} title="(주) 지크립토" description="연구원 (개발), 2024.03 ~ 2024.08" details={[
                    {
