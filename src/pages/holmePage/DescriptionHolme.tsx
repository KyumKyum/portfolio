        ...
        <div className="flex flex-col h-full bg-white mx-14 py-10">
            <div className="flex flex-col h-full items-center p-10">
                <div className="flex flex-col w-full items-center mb-4">
                    ...
                    <span>
                        <ScramblingText
                            className="text-5xl font-GW text-[#A6093A]"
                            text="홈 + 옮기다 = Holme"
                        />
                    </span>
                </div>
            ...
            <div className="flex w-full px-10 mb-8">
                ...
                <div className="flex flex-col w-1/2 justify-center flex-wrap">
                    <p className="font-Suit text-lg mb-6">
                    ...
                    <p className="font-Suit text-lg">
                        Holme은 IoT기기들이 있는 <span className="text-[#f3af61]">스마트 호텔</span>과 같은 공간에서
                        <br /><span className="text-teal-700">QR코드</span>를 통해 본인의 스마트 홈 설정을 곧바로 적용할 수 있습니다.
                        <br />즉, 새로운 환경에서도 내 집처럼 생활할 수 있는
                        <br /><span className="italic">"이동 가능한 집"</span> 을 소프트웨어적으로 구현한 프로젝트 입니다.
                    </p>
                </div>
            </div>
            <div className="flex w-full px-10 mb-8">
                <div className="flex flex-wrap flex-col w-1/2 justify-center items-end">
                    <p className="font-Suit text-lg mb-6 text-end">
                        이 프로젝트는
                    ...
                    <p className="font-Suit text-lg text-end">
                        저는 해당 프로젝트의 <span className="font-bold">개발 총괄</span>을 맡았고,
                        <br />기존에 공부하던 것을 바탕으로<span className="font-bold"> MSA 구조의 서비스를 </span>설계하였습니다.
                        <br />평소에 눈여겨보던<span className="font-bold"> gRPC </span>를 사용하여
                        <br />백엔드 서버와 IoT 기기간 빠른 소통이 가능하도록 개발하였고,
                        <br /><span className="font-bold">ChatGPT API</span>를 활용하여 Generative AI를 간단하게 구현하는 등
            ...
            <div className="flex w-full px-10 mb-8">
                ...
                <div className="flex flex-col w-1/2 justify-center flex-wrap mb-8">
                    <p className="font-Suit text-lg text-start mb-6">
                        너무나도 촉박했던<span className="font-bold"> AI Speaker의 timeout 문제</span>,
                        <br />생각보다 <span className="font-bold">자료가 부족했던 </span>Matter 기술,
                        <br />서로 다른 분야에서 전문가였던 <span className="font-bold"> 팀원간 커뮤니케이션 코스트 문제</span>,
                    ...
                    <p className="font-Suit text-lg text-start mb-6">
                        ...
                        <br />서로 협력하여 Matter 기술에 대한<span className="font-bold"> 자료 조사를 진행했으며 </span>,
                        <br /> <span className="font-bold">Slack</span>와 같은 협업툴을 사용하여 커뮤니케이션 코스트를 낮추고,
                        <br />기획을 보다 확실히 하여<span className="font-bold"> Demo를 완성하는 </span>과정을 통해
                        <br />해당 문제들을 하나하나 극복해 나아갔습니다.
                    </p>
                    <p className="font-Suit text-lg text-start">
                        이 모든 노력의 결과는, 위에서 언급했다시피
                        <br /><span className="font-bold">양사 모두에게서 최우수상을 수상함으로</span> 입증이 되었습니다.
                    </p>
                </div>
            </div>
            <div className="flex w-full px-10 mb-8">
                <div className="flex flex-wrap flex-col w-1/2 justify-center items-end">
                    ...
                    <span className="font-Suit text-lg text-end">
                        <ul>
...
export default DescriptionHolme;
