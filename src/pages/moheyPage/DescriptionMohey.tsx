        ...
        <div className="flex flex-col h-full bg-white mx-14 py-10">
            <div className="flex flex-col h-full items-center p-10">
                <div className="flex flex-col w-full items-center mb-4">
                    ...
                    <span>
                        <ScramblingText
                            className="text-5xl font-GW text-[#007FFC]"
                            text="모여서 Hey! Mohey!"
                        />
                    </span>
                </div>
            ...
            <div className="flex w-full px-10">
                <div className="flex flex-wrap flex-col w-1/2 justify-center items-end">
                    <p className="font-Suit text-lg mb-6 text-end">
                        ...
                        <br />이를 통해 <span className="font-bold">시스템 안정성과 확장성을 고려한 서버 구조 설계</span>,
                        <br /><span className="font-bold">실시간 서비스 지원 능력</span>, 그리고 <span className="font-bold">데이터 기반의 서비스 개선</span> 등
            ...
            <div className="flex w-full px-10 justify-center my-14">
                <p className="font-Suit text-xl text-center">
                    협업 활동과 갈등 상황, 예상치 못한 상황과 그에 대한 대처 등,
                    <br />정말 많은 경험을 하였고, 그 모든 경험은 저에게 개발자의 세계에 깊은 뿌리를 내리는 양분이 되었습니다.
                    <br />모헤이 프로젝트는 저를 한층 더 깊이 있는 개발자로 성장하게 해준 매우 소중한 경험이었습니다. :)
                </p>
            </div>
        </div>
    );
...
export default DescriptionMohey;
