        ...
        <div className="flex flex-col h-full bg-white mx-4 py-10">
            <div className="flex flex-col h-full items-center p-10">
                <div className="flex flex-col w-full items-center mb-4">
                    ...
                    <span>
                    <ScramblingText
                            className="text-2xl font-GW text-[#FD5D0F]"
                            text="Flowery"
                        />
                    </span>
                </div>
                <p className="font-Watermelon text-center">
            ...
            <div className="flex flex-col w-full px-10 mb-8">
                ...
                <div className="flex flex-col justify-center flex-wrap">
                    ...
                    Flowery는
                        <br/><span className="text-[#FD5D0F]">"하루에 3가지 일을 성공하면 성공한 하루다!"</span>
                        <br/>라는 표어 하에 만들어지고 있는
                        <br/><span className="font-bold">해빗 트래커 서비스</span>이며,
                    ...
                    저의 목표는 단순한 서비스를 만드는 것이 아닌,
                        ...
                        <br/>동시에 <span className="text-blue-800">하나의 큰 팀을 운영하는</span>
                        <br/>경험을 쌓는 것이었습니다.
                    </p>
            ...
            <button type="button" className="px-10" onClick={() => {
                    ...
                    <p className="font-Suit text-[11px]">
                    <span className="text-[#FD5D0F]">Flowery</span>는 성장하는 프로젝트입니다!<br/><span className="border-b-[1px] border-black">링크</span>를 클릭하여 프로젝트를 구경해보세요 :)
                    </p>
                </button>
            </div>
        </div>
...
export default MDescriptionFlowery;
